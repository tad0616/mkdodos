...
$config_enable['bg_img'] = array('enable' => '0', 'min' => '', 'max' => '', 'require' => '0', 'default' => '');
...
$config_enable['bg_position'] = array('enable' => '0', 'min' => '', 'max' => '', 'require' => '0', 'default' => 'left top');
...
$config_enable['use_slide'] = array('enable' => '0', 'min' => '', 'max' => '', 'require' => '', 'default' => '');
...
$config_enable['logo_position'] = array('enable' => '0', 'min' => '', 'max' => '', 'require' => '0', 'default' => 'slide');
...
$config_enable['bt_bg_color'] = array('enable' => '1', 'min' => '', 'max' => '', 'require' => '0', 'default' => '#7FBF7F');

//區塊標題圓角設定[theme_css_blocks.tpl]，值： 1 （圓角）, 0 （直角）
$config_enable['bt_radius'] = array('enable' => '0', 'min' => '', 'max' => '', 'require' => '0', 'default' => '0');

//區塊標題設定按鈕[theme_css_blocks.tpl]，值： right （右）, left （左）
$config_enable['block_config'] = array('enable' => '0', 'min' => '', 'max' => '', 'require' => '0', 'default' => 'right');
...
$config_enable['block_style'] = array('enable' => '', 'min' => '', 'max' => '', 'require' => '', 'default' => '');

//區塊標題區樣式手動設定[theme_css_blocks.tpl]，值： 1 （重複）, 0 （不重複）
$config_enable['block_title_style'] = array('enable' => '', 'min' => '', 'max' => '', 'require' => '', 'default' => '');
...
$config_enable['navbar_color_hover'] = array('enable' => '1', 'min' => '', 'max' => '', 'require' => '0', 'default' => 'yellow');
